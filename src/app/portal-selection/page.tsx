...
const PortalSelection = () => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
        ...
        if (selectedRoute && selectedPortal === null) {
            // Clear the selection to allow the user to choose again if they navigate back
            localStorage.removeItem("selectedPortalRoute");
        }
    }
  }, [router, selectedPortal]);
